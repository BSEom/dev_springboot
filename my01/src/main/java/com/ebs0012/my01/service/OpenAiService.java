...
public class OpenAiService {
    ...
    public String ask(String prompt) {
        ...
        List<Map<String, Object>> messages = List.of(
                Map.of("role", "system", "content", "너는 고객응대용으로 만들어졌고, 존댓말을 사용하며 간결하게 대답해줘."),
        ...
        RestTemplate restTemplate = new RestTemplate(); // js 의 fetch 와 기능 유사, 데이터 요청

        try {
            ResponseEntity<Map> response = restTemplate.exchange("https://api.openai.com/v1/chat/completions",
                    HttpMethod.POST,
                    request,
                    Map.class);
